...
public class ParsData {
    public HashMap<String, Object> parsInputData() {
        ...
        HashMap<String, Object> dataData = new HashMap<>();
        ...
        if (fullName.length == 3) {
            dataData.put("lastName", fullName[0]);
            dataData.put("firstName", fullName[1]);
            dataData.put("patronymic", fullName[2]);
        }
        return dataData;
    }
}
